...
namespace Silverlake.Utility
{
    ...
    public class Department
    {
        ...
        public List<DepartmentUser> DepartmentIdDepartmentUsers { get; set; }
        public List<BranchDepartment> DepartmentIdBranchDepartments { get; set; }
        public List<Batch> DepartmentIdBatches { get; set; }
    }
}

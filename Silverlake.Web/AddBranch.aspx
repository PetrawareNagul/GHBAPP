<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBranch.aspx.cs" Inherits="Silverlake.Web.AddBranch" %>
...
<body>
    <div id="addBranchForm" runat="server">
        <div class="row" id="FormId" data-value="addBranchForm">
            <div class="col-md-12">

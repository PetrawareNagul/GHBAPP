<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Simulation.aspx.cs" Inherits="Silverlake.Web.Simulation.Simulation" %>
...
<body>
    <form id="simulationForm" runat="server">
                                    ...
                                    <div class="action-section">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <button data-original-title="Add Batch" data-trigger="hover" data-placement="bottom" type="button" class="popovers btn action-button pull-right" data-action="Add" data-url="Simulation/AddBatch.aspx" data-title="Add"><i class="fa fa-plus"></i></button>
                                                <button data-original-title="Edit Batch" data-trigger="hover" data-placement="bottom" data-content="Select one record" type="button" class="popovers btn action-button pull-right" data-action="Edit" data-url="Simulation/AddBatch.aspx" data-title="Edit"><i class="fa fa-edit"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

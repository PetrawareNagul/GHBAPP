            ...
            $('.chat-input').keypress(function (ev) {
                ...
                if (p == 13) {
                    if (chatText == "") {
                        ...
                        $('<li class="clearfix"><div class="chat-avatar"><img src="/Content/images/chat-user-thumb.png" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>John Carry</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
                    }
                    $(this).val('');

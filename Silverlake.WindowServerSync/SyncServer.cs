...
using Silverlake.WindowServerSync.Properties;
using Silverlake.WindowServerSync.ServiceCalls;
using System;
...
{
    public partial class SyncServer : MetroForm
    {
        ...
        public string MFilesPath = ConfigurationManager.AppSettings["MFiles"].ToString();
        ...
        //public bool isProcessingNetwork;

        //private BackgroundWorker backgroundWorkerProcessMoveFilesToNetwork;
        ...
        public SyncServer()
        {
            ...
            this.mFiletimer = new System.Timers.Timer(30000);  // 150000 milliseconds = 2.5 min
            ...
            //CustomValidator.isValidNo("E-LIBRARY", "AA", "00");
            ...
            this.Resize += new EventHandler(SyncServer_Resize);
        ...
        private void notifyIcon_BalloonTipClosed(object sender, EventArgs e)
        {
            ...
            notifyIcon.BalloonTipText = "For Server";
        ...
        private void SyncServer_Resize(object sender, EventArgs e)
        {
        ...
        {
            //backgroundWorkerProcessMoveFilesToNetwork = new BackgroundWorker();
            //backgroundWorkerProcessMoveFilesToNetwork.DoWork += new DoWorkEventHandler(backgroundWorkerProcessMoveFilesToNetwork_DoWork);
            //backgroundWorkerProcessMoveFilesToNetwork.WorkerReportsProgress = false;
            //backgroundWorkerProcessMoveFilesToNetwork.WorkerSupportsCancellation = true;
            //backgroundWorkerProcessMoveFilesToNetwork.RunWorkerCompleted += new RunWorkerCompletedEventHandler(backgroundWorkerProcessMoveFilesToNetwork_RunWorkerCompleted);
            //backgroundWorkerProcessMoveFilesToNetwork.RunWorkerAsync();
        ...
        //private void backgroundWorkerProcessMoveFilesToNetwork_DoWork(object sender, DoWorkEventArgs e)
        //{
        //    isProcessingNetwork = true;
        //    BackgroundWorker worker = sender as BackgroundWorker;
        //    e.Result = MoveFilesToNetwork(worker, e);
        //}
        //private void backgroundWorkerProcessMoveFilesToNetwork_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        //{
        //    if (e.Error != null)
        //    {
        ...
        public object MoveFilesToNetwork(BackgroundWorker worker, DoWorkEventArgs e)
        {
            ...
            if (files.Count() > 0)
            {
                LogWriter logWriter = new LogWriter("MoveFilesToNetwork: " + files.Count());
            }
            foreach (string file in files)
            {
                string fileName = Path.GetFileName(file);
                LogWriter logWriter = new LogWriter("MoveFilesToNetwork: file - " + fileName);
        ...
        public void MFileXmlToSplit(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                foreach (var set in sets)
                {
                    ...
                    {
                        LogWriter logWriter = new LogWriter("MFileXmlToSplit batch " + batch.DepartmentId);

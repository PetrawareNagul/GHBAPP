...
namespace SyncClient
{
    public class Services
    {
        ...
        public static bool PostBatchStatusXMLFile(string batchStatusXMLPath)
        {
            ...
            {
                logWriter = new LogWriter("Post Status: " + batchStatusXMLPath + " - Exception");
                logWriter = new LogWriter("Post Status: " + ex.Message);
            }
            return false;
        }
        ...
        public static List<string> PostBatchXmlToSplit(string batchXMLPath)
        {
            ...
            try
            {
                ...
                if (fileExtension.ToLower() == ".xml")
                {
                    ...
                    if (xdoc.Root.Name != "records")
                    {
                        ...
                        logWriter = new LogWriter("Post Batch To Split: Bad XML");
                    }
            ...
            {
                logWriter = new LogWriter("Post Batch To Split: " + batchXMLPath + " - Exception");
                logWriter = new LogWriter("Post Batch To Split: " + ex.Message);
            }
            return setXMLPaths;
        }
        ...
        public static bool PostSetFile(string setFilePathfile)
        {
                    ...
                    if (matchedFiles.ToList().Count - 1 == Convert.ToInt32(splitFileName.ToList().Last().ToString()))
                    {
                        ...
                        foreach (string matchFile in matchedFiles)
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                logWriter = new LogWriter("Post Set file: " + ex.Message);
                            }
                        }
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                logWriter = new LogWriter("Post Set: " + ex.Message);
                return false;
            }
